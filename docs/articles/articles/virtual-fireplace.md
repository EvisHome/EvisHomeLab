...
date: 2023-12-02
description: Virtual Fireplace that fires up based on room occupancy and TV state.
image: virtual-fireplace/main-picture.png
highlight: false
draft: false
tags:
  - ESP32
...
![Virtual Fireplace](../virtual-fireplace/main-picture.png)
...
![Node-Red Flow](../virtual-fireplace/node-red-flow.png)
